...
| 3 | Sep 14–18 | 5 | 2 — CAD | | F360 orientation + CAD hygiene; measurement fundamentals; 3D printing / rapid prototyping intro; **C1: Front Wheel Hub** (practice sketches → print) | D: C1 — key dimensions + iteration log |
| 4 | Sep 21–25 | 5 | 2 — CAD | | **C2: Rear Wheel Hub** (builds on C1, adds new features); intro to **C3: Motor Mount** | D: C2 — key dimensions + iteration log |
...
| 19 | Jan 18–21 | 3 | Robot Tuning / Midterm | 🔴 MLK Day Jan 18 · Last student day Thu Jan 21 · Records Day Jan 22 (no students) | IMU heading hold; catch-up; **Midterm Exam** (covers EDP, CAD, Safety, Programming Basics) | Midterm Exam |
...
| 38 | Jun 7–11 | 4.5 | Wrap-up | Half day Jun 11 (last day) | End-of-year reflection; equipment return | |
