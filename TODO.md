...
- [ ] Create Fusion 360 user accounts and hubs

---

## Pending

### Portfolio / Teacher Portal
...
- [ ] Portfolio consolidation — merge Robotics + FRC portfolios (deferred)

---

## Completed

- [x] HSAER S2 deliverables — added 10 new deliverables, now 14 per semester
- [x] DBL deliverables — added all 27 to portfolio and teacher portal
- [x] DBL portfolio bugs — fixed label formatting (42.4), missing deliverables, title, hard-refresh sign-in
